...
{
    public partial class Frm_Security_TwoFactorVerify : Form
    {
        #region PropiedadesIniciales
        // Propiedad para recibir datos desde Frm_Security_Login
        ...
        public Frm_Security_TwoFactorVerify()
        {
            InitializeComponent();
            authController = new Ctrl_Security_Auth();
            ConfigurarBarraTitulo();
            this.Load += Frm_Security_TwoFactorVerify_Load;
        }

        private void Frm_Security_TwoFactorVerify_Load(object sender, EventArgs e)
        {
        ...
        private void ValidarCodigo()
        {
            ...
            if (UserData == null || string.IsNullOrEmpty(UserData.TwoFactorSecret))
            {
                MessageBox.Show("No se encontró información de autenticación para este usuario.", "Error",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            if (authController.VerifyTwoFactorCode(UserData.TwoFactorSecret, Txt_Codigo.Text))
            {
            ...
            {
                MessageBox.Show("El código ingresado es incorrecto.", "Código inválido",
