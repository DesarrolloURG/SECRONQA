...
{
    public partial class Frm_Transfers_SearchBeneficiario : Form
    {
        #region PropiedadesIniciales
        private Frm_Transfers_Managment _frmPadre;
        public Frm_Transfers_SearchBeneficiario(Frm_Transfers_Managment frmPadre)
        {
            InitializeComponent();
            _frmPadre = frmPadre;
        ...
        private void Frm_Transfers_SearchBeneficiario_Load(object sender, EventArgs e)
        {
