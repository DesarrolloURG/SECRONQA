...
{
    public partial class Frm_FA_SearchAccount : Form
    {
        #region PropiedadesIniciales
        // Referencia al formulario padre
        private Frm_FixedAssetCategories _frmPadre;

        // Constructor que recibe la referencia del padre
        public Frm_FA_SearchAccount(Frm_FixedAssetCategories frmPadre)
        {
            InitializeComponent();
            _frmPadre = frmPadre;
        ...
        private void Frm_FA_SearchAccount_Load(object sender, EventArgs e)
        {
