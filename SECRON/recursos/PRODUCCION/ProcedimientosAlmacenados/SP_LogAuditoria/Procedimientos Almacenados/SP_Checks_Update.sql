CREATE OR ALTER PROCEDURE SP_Checks_Update
    @CheckId INT, @CheckNumber VARCHAR(20), @IssueDate DATETIME, @IssuePlace VARCHAR(50) = NULL,
    ...
    @Complement VARCHAR(50) = NULL, @Predeclared BIT, @Compensation DECIMAL(18,2),
    @Vacation DECIMAL(18,2), @Bill VARCHAR(50) = NULL, @Aguinaldo DECIMAL(18,2),
    @LastComplement BIT, @ModifiedBy INT = NULL
AS
BEGIN
    ...
    BEGIN TRANSACTION
    BEGIN TRY
        UPDATE Checks SET CheckNumber = @CheckNumber, IssueDate = @IssueDate,
